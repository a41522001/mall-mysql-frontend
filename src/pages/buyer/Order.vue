...
<script setup lang="ts">
  import { reactive, shallowReactive, ref, onMounted, computed, inject, watch } from 'vue';
  import { useUserStore } from '@/stores/userStore';
  import { useSysStore } from '@/stores/sysStore'; 
  import type { Product, UserInfo, Select, OrderQuery, AllOrder, Status } from '@/types/interface';
  import { useRouter } from 'vue-router';
  import { apiCancelOrder, apiGetOrder, apiGetSystemSetting } from '@/utils/apiClient';
  ...
  const orderIdCondition = (value: string): boolean => {
    return !query.orderNo || value.toLowerCase().includes(query.orderNo.toLocaleLowerCase());
  }
